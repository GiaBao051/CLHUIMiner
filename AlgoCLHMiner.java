...
public class AlgoCLHMiner {
    ...
    /**
     * Tìm một Element trong UtilityList bằng tid, sử dụng tìm kiếm nhị phân.
     * 
     * @param ulist UtilityList cần tìm kiếm.
     * @param tid   ID giao dịch cần tìm.
     * @return Element tìm thấy hoặc null.
     */
